...
pub fn init_overlay_paths(user_id: u32, container_id: &str) -> OverlayPaths {
    ...
    //let base_path = PathBuf::from(home).join("PESU/Projects/bento.rs/crates/libbento/src/{user_id}/{container_id}/");
    let base_path = PathBuf::from(format!("/home/krhdeb/PESU//Projects/bento.rs/crates/src/libbento/src/{user_id}/{container_id}/"));
